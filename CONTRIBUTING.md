...
This repository is for improving the IDEA Loop framework itself.
Contributions from PMs, designers, engineers, founders, researchers, and non-coders are welcome.
...
This repo is not the place to submit your product's loop execution artifacts as primary content.
Use your own product repo or workspace for project-specific loop outputs; link them here only when they teach the framework.
...
1. **Framework gap**: What weakness or ambiguity in IDEA are you addressing?
2. **Proposed change**: What method, tool, or technique are you introducing?
3. **Why this helps**: What failure mode does it reduce or what quality does it improve?
4. **How to apply**: Step-by-step usage in a real loop session
5. **Evidence**: Examples, references, or field notes
6. **Boundaries**: Where this should not be used
7. **Adoption signal**: How we would know this improved the framework
